const rating_cards = document.querySelectorAll(".rate span");
const submit_btn = document.querySelector(".btn-name");
const rate_point = document.getElementById("rate");
const rating_section = document.querySelector(".first-page");
